...
class AppLocalizationsBg extends AppLocalizations {
  ...
  @override
  String get tcpBookmarksLabel => 'Последни връзки';

  @override
  String get tcpBookmarksSetName => 'Задайте име за отметката';

  @override
  String get tcpBookmarksFavouritesSubtitle =>
      'Когато е отбелязана като любима, връзката не се премахва от историята';
  ...
  String settings_aboutVersion(String version) {
    return 'MeshCore Open (Advanced mod), версия $version';
  }
  ...
  String get settings_channelResendTimeoutTitle =>
      'Забавяне при ръчно повторно изпращане';

  @override
  String get settings_channelResendTimeoutSubtitle =>
      'Влияе и на вътрешния механизъм за премахване на дублирано показване на изходящи съобщения';

  @override
  String get settings_channelMaxbytesOutgoingTitle =>
      'Ограничение на изходящия payload за канали, байтове';
  ...
  String get settings_quickAnswersSubtitle =>
      'Списък с фрази, достъпни за избор като бързи отговори. Те се задават към контакти/канали в техните настройки.';

  @override
  String get settings_quickAnswersAddText => 'Моля, въведете текст';

  @override
  String get settings_quickAnswersEditText => 'Редактиране на отговор';

  @override
  String get settings_quickAnswersSelect => 'Активиране на тези отговори';

  @override
  String get settings_quickAnswersExists => 'Вече съществува';
  ...
  @override
  String get settings_quickAnswersSendAtSelect => 'Изпращане при избор';
  ...
  String get appSettings_enableTimeSeconds =>
      'Показване на секундите в информацията за съобщението';

  @override
  String get appSettings_showKeyboardHidingButton =>
      'Показване на бутон за скриване на клавиатурата';
  ...
  @override
  String get contacts_requestRegions => 'Заяви регионите';
  ...
  @override
  String get settings_mcmpTextLimit => 'Лимит за поставяне на MCMP текст';

  @override
  String get settings_sendingDelayForCancellation =>
      'Забавяне на изпращането за отмяна';

  @override
  String get settings_useSendingDelay => 'Използване на забавяне при изпращане';

  @override
  String get chat_cancelSend => 'отмяна на изпращането';
  ...
  String get channels_hashtagMcoaHint =>
      'Главни букви и „_“ се поддържат само в MCOa';
  ...
  String chat_retryingMessageWait(Object seconds) {
    return 'Моля, изчакайте $seconds секунди преди повторно изпращане';
  }
  ...
  String get map_regionRequestPathMustEndWithTarget =>
      'Маршрутът трябва да завършва с целевия ретранслатор.';
  ...
  String get map_wardriveDiscoverySent =>
      'Заявката за wardrive discovery е изпратена.';

  @override
  String get map_wardriveUploadCancelled => 'Качването на wardrive е отменено.';

  @override
  String map_wardriveDiscoveryFailed(String error) {
    return 'Wardrive discovery неуспешно: $error';
  }

  @override
  String map_wardriveRequests(int requests, int responses) {
    return 'Заявки: $requests  Отговори: $responses';
  }

  @override
  String map_wardriveLastRequest(String time) {
    return 'Последна заявка: $time';
  }

  @override
  String get map_wardrivePhoneGpsNotUpdated =>
      'GPS на телефона: още не е обновен';

  @override
  String map_wardrivePhoneGpsError(String error) {
    return 'GPS на телефона: $error';
  }

  @override
  String map_wardrivePhoneGps(String latitude, String longitude) {
    return 'GPS на телефона: $latitude, $longitude';
  }

  @override
  String get map_wardriveNoResponses => 'Все още няма discovery отговори.';

  @override
  String get map_wardriveDataTooltip => 'Данни на wardrive';

  @override
  String get map_wardriveUploadData => 'Качване на данни';

  @override
  String get map_wardriveManageUploadSites =>
      'Управление на сайтове за качване';
  ...
  String map_wardriveSampleSaveError(String error) {
    return 'Запазване на семпъл: $error';
  }

  @override
  String map_wardriveCoverageCells(int count) {
    return 'Клетки на покритие: $count';
  }
  ...
  @override
  String get map_wardriveAutoUploadDisabled => 'Автокачването е изключено.';

  @override
  String get map_wardriveNoSamplesToUpload =>
      'Няма wardrive семпли за качване.';

  @override
  String get map_wardriveUploadingSamples => 'Качване на семпли...';

  @override
  String map_wardriveUploadingTo(String site) {
    return 'Качване към $site...';
  }

  @override
  String map_wardriveUploadBatch(int current, int total) {
    return 'Пакет $current от $total';
  }

  @override
  String map_wardriveUploadSamplesProgress(int sent, int total) {
    return 'Изпращане $sent от $total';
  }
  ...
  @override
  String get map_wardriveUploadWaitingConnection => 'Изчакване на връзка';

  @override
  String get map_wardriveUploadConnectionEstablished =>
      'Връзката е установена, качване';

  @override
  String get map_wardriveUploadProcessingServer =>
      'Данните са качени, сървърът обработва';

  @override
  String map_wardriveUploadServerResponse(int statusCode) {
    return 'Сървърът обработи данните, отговор $statusCode';
  }
  ...
  String map_wardriveUploadServerError(int statusCode) {
    return 'Грешка на сървъра $statusCode';
  }
  ...
  String map_wardriveUploadFailed(String error) {
    return 'Качването на wardrive е неуспешно: $error';
  }

  @override
  String get map_wardriveUploadComplete => 'Качването завърши';

  @override
  String get map_wardriveUploadResults => 'Резултати от качването';

  @override
  String map_wardriveSamplesUploaded(int count) {
    return 'Качени семпли: $count';
  }

  @override
  String get map_wardriveSelectUploadSites => 'Изберете сайтове за качване:';

  @override
  String get map_wardriveNoUploadSitesConfigured =>
      'Няма настроени сайтове за качване';

  @override
  String get map_wardriveAddSite => 'Добавяне на сайт';

  @override
  String get map_wardriveUploadSitesUpdated =>
      'Сайтовете за качване са обновени.';

  @override
  String get map_wardriveAddUploadSite => 'Добавяне на сайт за качване';

  @override
  String get map_wardriveEditUploadSite => 'Редактиране на сайт за качване';

  @override
  String get map_wardriveNameLabel => 'Име';

  @override
  String get map_wardriveUrlLabel => 'URL';

  @override
  String get map_wardriveUploadBatchSize => 'Размер на пакет за качване';

  @override
  String map_wardriveUploadBatchSizeInvalid(int min, int max) {
    return 'Използвайте стойност от $min до $max';
  }

  @override
  String get map_wardriveTreatTimeoutAsSuccess =>
      'Третирай таймаута като успех';

  @override
  String get map_wardriveNameRequired => 'Името е задължително';

  @override
  String get map_wardriveNameExists => 'Името вече съществува';

  @override
  String get map_wardriveValidUrlRequired => 'Необходим е валиден URL';

  @override
  String get map_wardriveDeleteSite => 'Изтриване на сайт';
  ...
  String get map_wardriveNoSamplesToExport =>
      'Няма wardrive семпли за експорт.';

  @override
  String get map_wardriveExportShareText => 'wardrive семпли от meshcore-open';

  @override
  String get map_wardriveSamplesExported =>
      'Wardrive семплите са експортирани като JSON файл.';

  @override
  String map_wardriveExportFailed(String error) {
    return 'Експортът на wardrive е неуспешен: $error';
  }

  @override
  String get map_wardriveImportSamples => 'Импорт на wardrive семпли';

  @override
  String get map_wardriveImportHint =>
      'Поставете експортирания wardrive JSON тук';

  @override
  String get map_wardriveNoNewSamplesImported =>
      'Няма импортирани нови wardrive семпли.';

  @override
  String map_wardriveSamplesImported(int count) {
    return 'Импортирани wardrive семпли: $count.';
  }

  @override
  String map_wardriveImportFailed(String error) {
    return 'Импортът на wardrive е неуспешен: $error';
  }

  @override
  String get map_wardriveNoSamplesToClear =>
      'Няма wardrive семпли за изчистване.';

  @override
  String get map_wardriveClearSamplesTitle =>
      'Да се изчистят ли wardrive семплите?';

  @override
  String map_wardriveClearSamplesConfirm(int count) {
    return 'Това ще изтрие $count запазени семпли от устройството.';
  }
  ...
  @override
  String get repeater_packetErrors => 'Грешки в пакетите';
  ...
  String get channelPath_outgoingSentByRadioAt =>
      'Изчакване за предаване по радио, сек';
  ...
  @override
  String get channels_mcmpCompression => 'MCMP компресия';
  ...
  @override
  String get chat_canvasV4Title => 'Векторно платно MCOimg v4';

  @override
  String get chat_canvasV4SetupTitle => 'Ново векторно платно';

  @override
  String get chat_canvasV4Grid => 'Координатна мрежа';

  @override
  String get chat_canvasV4GridDescription =>
      'По-малката мрежа намалява payload, по-голямата повишава точността при разполагането на фигурите.';

  @override
  String get chat_canvasV4Background => 'Фон';

  @override
  String get chat_canvasV4Transparent => 'Прозрачен';

  @override
  String get chat_canvasV4Fill => 'Запълване';

  @override
  String get chat_canvasV4Stroke => 'Контур';

  @override
  String get chat_canvasV4StrokeWidth => 'Дебелина на контура';

  @override
  String get chat_canvasV4Closed => 'Затвори фигурата';

  @override
  String get chat_canvasV4HideFigure => 'Скрий фигурата';

  @override
  String get chat_canvasV4ShowFigure => 'Покажи фигурата';

  @override
  String get chat_canvasV4MoveUp => 'Премести нагоре';

  @override
  String get chat_canvasV4MoveDown => 'Премести надолу';

  @override
  String get chat_canvasV4Objects => 'Фигури';

  @override
  String get chat_canvasV4NoObjects => 'На платното още няма фигури';

  @override
  String get chat_canvasV4Calculate => 'Изчисли крайното изображение';

  @override
  String get chat_canvasV4Redo => 'Повтори';

  @override
  String get chat_canvasV4CanvasSettings => 'Настройки на платното';

  @override
  String get chat_canvasV4InvalidSize => 'От 1 до 256';

  @override
  String get chat_canvasV4LoadReference => 'Зареди референтно изображение';

  @override
  String get chat_canvasV4HideReference => 'Скрий референтното изображение';

  @override
  String get chat_canvasV4ShowReference => 'Покажи референтното изображение';

  @override
  String get chat_canvasV4RemoveReference =>
      'Премахни референтното изображение';

  @override
  String get chat_canvasV4ReferenceNotEncoded =>
      'Референтното изображение не влиза в payload';

  @override
  String get chat_canvasV4PaletteFull => 'Документът вече използва 64 цвята';

  @override
  String chat_canvasV4Payload(int bytes) {
    return 'Payload: $bytes байта';
  }

  @override
  String chat_canvasV4PayloadTooLarge(int bytes) {
    return 'Payload превишава наличния размер с $bytes байта';
  }

  @override
  String get chat_canvasV4ApplyStyle => 'Приложи стила';

  @override
  String get chat_canvasV4WaveHint =>
      'Посочете началото, края и дълбочината на вълната';

  @override
  String get chat_canvasV4ToolSelect => 'Избор и преместване';

  @override
  String get chat_canvasV4ToolDot => 'Точка';

  @override
  String get chat_canvasV4ToolPencil => 'Молив';

  @override
  String get chat_canvasV4ToolLine => 'Линия';

  @override
  String get chat_canvasV4ToolPolyline => 'Начупена линия';

  @override
  String get chat_canvasV4PolylineHint =>
      'Поставяйте върховете на контура. Докоснете първия връх или изберете начин на завършване.';

  @override
  String get chat_canvasV4FinishOpen => 'Завърши отворена';

  @override
  String get chat_canvasV4FinishClosed => 'Затвори';

  @override
  String get chat_canvasV4ToolRect => 'Правоъгълник';

  @override
  String get chat_canvasV4ToolEllipse => 'Елипса';

  @override
  String get chat_canvasV4ToolCircle => 'Кръг';

  @override
  String get chat_canvasV4ToolWave => 'Вълна';
  ...
  String get settings_modSettingsMonochromeSenderNames =>
      'Едноцветни имена на подателите';
  ...
  @override
  String get messageHistoryMigrationManage => 'Управление на хранилището';

  @override
  String get settings_modSettingsMessageStorage => 'Хранилище на съобщенията';

  @override
  String get messageHistoryDatabaseTitle => 'Управление на базата данни';

  @override
  String get messageHistoryDatabaseSubtitle =>
      'Статистика, възстановяване и поддръжка на историята на съобщенията';

  @override
  String get messageHistoryDatabaseOverview => 'Състояние на базата данни';

  @override
  String get messageHistoryDatabasePath => 'Път до базата данни';

  @override
  String get messageHistoryDatabaseFileSize => 'Размер на файла';

  @override
  String get messageHistoryDatabaseDirectCount => 'Лични съобщения';

  @override
  String get messageHistoryDatabaseChannelCount => 'Съобщения от канали';

  @override
  String get messageHistoryDatabaseReclaimable => 'Може да се освободи';

  @override
  String get messageHistoryDatabaseQuarantine => 'Карантина на преноса';

  @override
  String messageHistoryDatabaseQuarantineCount(int count, String size) {
    return 'Отхвърлени записи: $count · $size';
  }

  @override
  String get messageHistoryDatabaseQuarantineEmpty => 'Няма отхвърлени записи';

  @override
  String get messageHistoryDatabaseRetry => 'Повтори възстановяването';

  @override
  String get messageHistoryDatabaseRetryDescription =>
      'Повторно да се провери карантината с текущия анализатор и поправените съобщения да се върнат в историята.';

  @override
  String messageHistoryDatabaseRetryResult(int restored, int remaining) {
    return 'Възстановени: $restored, остават: $remaining';
  }

  @override
  String get messageHistoryDatabaseDiagnostic => 'Експортиране на диагностика';

  @override
  String get messageHistoryDatabaseDiagnosticDescription =>
      'Създаване на отчет без текста на съобщенията и без ключовете на контактите.';

  @override
  String get messageHistoryDatabaseRecovery =>
      'Експортиране на данни за възстановяване';

  @override
  String get messageHistoryDatabaseRecoveryDescription =>
      'Създаване на файл само с отхвърлените записи. Той може да съдържа лична кореспонденция.';

  @override
  String get messageHistoryDatabaseRecoveryWarningTitle =>
      'Експорт на поверителни данни';

  @override
  String get messageHistoryDatabaseRecoveryWarningDescription =>
      'Файлът за възстановяване съдържа оригиналния текст на отхвърлените съобщения и идентификаторите на разговорите. Прегледайте го, преди да го предоставите на някого.';

  @override
  String get messageHistoryDatabaseDeleteAfterExportTitle =>
      'Да се изтрие ли карантината след експорта?';

  @override
  String get messageHistoryDatabaseDeleteAfterExportDescription =>
      'Файлът за възстановяване вече е записан. Да се изтрият ли от базата експортираните отхвърлени данни?';

  @override
  String get messageHistoryDatabaseClearQuarantine =>
      'Изтриване на карантината';

  @override
  String get messageHistoryDatabaseClearQuarantineDescription =>
      'Изтриване на отхвърлените данни без възможност за възстановяване.';

  @override
  String get messageHistoryDatabaseClearWarningTitle =>
      'Да се изтрият ли отхвърлените данни?';

  @override
  String get messageHistoryDatabaseClearWarningDescription =>
      'След изтриването съобщенията от карантината няма да могат да бъдат нито възстановени, нито експортирани.';

  @override
  String get messageHistoryDatabaseMaintenance => 'Поддръжка';

  @override
  String get messageHistoryDatabaseIncrementalVacuum =>
      'Освобождаване на неизползваното място';

  @override
  String get messageHistoryDatabaseIncrementalVacuumDescription =>
      'Постепенно връщане на неизползваните страници на SQLite към операционната система.';

  @override
  String get messageHistoryDatabaseIncrementalVacuumUnavailableDescription =>
      'За тази база първо е необходим пълен VACUUM.';

  @override
  String get messageHistoryDatabaseFullVacuum =>
      'VACUUM (пълно преизграждане на базата)';

  @override
  String get messageHistoryDatabaseFullVacuumDescription =>
      'Пълно преизграждане на файла с базата данни. Операцията може да отнеме време и да изисква допълнително свободно място.';

  @override
  String get messageHistoryDatabaseFullVacuumWarningTitle =>
      'Пълно преизграждане на базата данни?';

  @override
  String get messageHistoryDatabaseFullVacuumWarningDescription =>
      'Не затваряйте приложението до края на операцията. На SQLite може да е необходимо допълнително място, колкото е текущата база данни.';

  @override
  String get messageHistoryDatabaseCopyPath => 'Копирай пътя';

  @override
  String get messageHistoryDatabasePathCopied => 'Пътят е копиран';

  @override
  String messageHistoryDatabaseExportSaved(String path) {
    return 'Файлът е записан: $path';
  }

  @override
  String get messageHistoryDatabaseExportShared =>
      'Файлът е предаден в системното меню за споделяне';

  @override
  String messageHistoryDatabaseDeleted(int count) {
    return 'Изтрити записи: $count';
  }
  ...
  String messageHistoryDatabaseOperationFailed(String error) {
    return 'Операцията не бе изпълнена: $error';
  }

  @override
  String get settings_supportDevelopment => 'Подкрепете разработката';

  @override
  String get donate_intro =>
      'Благодарим, че наминахте!\nАко харесвате модификацията, можете да подкрепите разработката ѝ с дарение.';

  @override
  String get donate_tipLinkLabel => 'Връзка за бакшиш:';

  @override
  String get donate_upstreamAuthor =>
      'Авторът на оригиналния meshcore_open — zjs81 — приема дарения тук:';

  @override
  String get chat_canvasV4ToolText => 'Текст';

  @override
  String get chat_canvasV4TextAlignLeft => 'Отляво';

  @override
  String get chat_canvasV4TextAlignCenter => 'Центрирано';

  @override
  String get chat_canvasV4TextAlignRight => 'Отдясно';

  @override
  String chat_canvasV4TextWidth(int cells) {
    return 'Ширина на областта: $cells';
  }

  @override
  String chat_canvasV4TextFontSize(int size) {
    return 'Размер на шрифта: $size';
  }
  ...
  String get settings_modSettingsRecoverLongEchoes =>
      'Възстановявай повторенията на дълги пакети';

  @override
  String get settings_modSettingsRecoverLongEchoesDscr =>
      'Разпознаване на копие от RX-дневника на наше съобщение в канал, отрязано от лимита на BLE кадъра';
  ...
  String get channels_scanQrInstructions =>
      'Насочете камерата към QR код на канал';

  @override
  String get channels_invalidQrCode => 'Това не е QR код на канал';
