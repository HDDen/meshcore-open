...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String settings_aboutVersion(String version) {
    return 'MeshCore Open (Advanced mod) $version版';
  }
  ...
  @override
  String get settings_infoDeviceName => 'ボード名';
  ...
  @override
  String get chat_canvasV4ToolText => 'テキスト';

  @override
  String get chat_canvasV4TextAlignLeft => '左揃え';

  @override
  String get chat_canvasV4TextAlignCenter => '中央揃え';

  @override
  String get chat_canvasV4TextAlignRight => '右揃え';
  ...
  String chat_unknownAppDataPlaceholder(
    ...
    return '不明なサブタイプのパケットを受信しました（$namespace、サブタイプ $subtype バージョン $version）。アプリの更新が必要かもしれません';
  }
  ...
  @override
  String get channels_scanQrInstructions => 'カメラをチャンネルの QR コードに向けてください';

  @override
  String get channels_invalidQrCode => 'これはチャンネルの QR コードではありません';

  @override
  String channels_qrAlreadyAdded(String name) {
    return 'チャンネル「$name」はすでに追加されています';
  }

  @override
  String get channels_shareQrHint => 'QR コードをスキャンしてチャンネルを追加します。';

  @override
  String get channels_shareSecretKey => 'シークレットキー';

  @override
  String get channels_shareRegionScope => 'チャンネルのリージョン';

  @override
  String get channels_shareKeyCopied => 'シークレットキーをコピーしました';
