...
static const uint8_t mcotxt_ru_primary_count = 31u;
static const uint8_t mcotxt_ru_extension_count = 13u;
static const uint8_t mcotxt_ru_symbol_count = 44u;
static const uint8_t mcotxt_ru_uppercase_count = 33u;

static const uint16_t mcotxt_ru_primary_symbols[31] = {
  0x0020u, 0x0441u, 0x043Cu, 0x0443u, 0x0440u, 0x043Au, 0x0435u, 0x043Bu, 0x043Du, 0x0438u,
  0x044Fu, 0x0442u, 0x0431u, 0x0434u, 0x0433u, 0x0447u, 0x0432u, 0x0430u, 0x0437u, 0x043Eu,
  0x044Bu, 0x043Fu, 0x0439u, 0x0445u, 0x0436u, 0x0448u, 0x044Eu, 0x044Cu, 0x044Du, 0x0449u,
  0x0446u,
};

static const uint16_t mcotxt_ru_extension_symbols[13] = {
  0x0444u, 0x0031u, 0x0032u, 0x0033u, 0x0451u, 0x0034u, 0x0035u, 0x0038u, 0x0037u, 0x0036u,
  0x0039u, 0x0030u, 0x044Au,
};
...
static const uint8_t mcotxt_ru_top4[176] = {
  8u, 21u, 1u, 16u, 11u, 6u, 0u, 19u, 0u, 6u, 19u, 17u, 0u, 11u, 13u, 24u, 19u, 17u, 6u, 9u, 19u,
  17u, 0u, 9u, 0u, 11u, 8u, 4u, 9u, 27u, 19u, 6u, 17u, 19u, 6u, 9u, 0u, 11u, 8u, 7u, 0u, 11u, 18u,
  7u, 19u, 17u, 0u, 27u, 19u, 4u, 20u, 6u, 17u, 19u, 6u, 9u, 19u, 13u, 17u, 9u, 6u, 11u, 17u, 9u,
  0u, 6u, 17u, 19u, 0u, 7u, 5u, 11u, 17u, 0u, 8u, 9u, 0u, 11u, 13u, 16u, 0u, 22u, 25u, 7u, 19u, 4u,
  9u, 17u, 0u, 11u, 15u, 5u, 19u, 0u, 17u, 3u, 6u, 8u, 13u, 9u, 6u, 9u, 17u, 5u, 0u, 11u, 15u, 1u,
  0u, 8u, 5u, 1u, 11u, 5u, 8u, 7u, 6u, 17u, 35u, 9u, 9u, 6u, 17u, 0u, 9u, 19u, 7u, 6u, 0u, 42u,
  32u, 36u, 0u, 42u, 37u, 33u, 0u, 42u, 34u, 33u, 0u, 11u, 2u, 7u, 0u, 42u, 34u, 37u, 0u, 42u, 40u,
  37u, 0u, 40u, 42u, 33u, 0u, 39u, 42u, 37u, 0u, 37u, 38u, 42u, 0u, 41u, 42u, 33u, 0u, 42u, 2u, 5u,
  6u, 10u, 35u, 9u,
};
