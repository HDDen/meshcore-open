...
/// Whether this build profile includes the native AEIC implementation.
const bool kImageCodecFeatureAvailable = true;

/// Compile-time answer to "can this build turn bytes into a picture?".
///
/// The pieces needed by this path now exist: the pure-Dart
