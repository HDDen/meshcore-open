...
Copy-Item -LiteralPath (Join-Path $root 'pubspec.lite-aeic.yaml') -Destination (Join-Path $root 'pubspec.yaml') -Force
...
Write-Host 'Enabled lite-aeic profile without LLM translation.'
